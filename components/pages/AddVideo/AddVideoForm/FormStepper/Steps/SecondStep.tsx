  ...
  return (
    <Flex direction="column" gap="40px">
      ...
      <Grid row reverseDirection gap="40px" justifyContent="stretch">
        <Grid column>
          <Input
            register={register('businessTitle')}
            variant={InputVariants.contained}
            label="כותרת משנית לעסק"
          />
        </Grid>
      </Grid>
      <Grid row reverseDirection gap="40px" justifyContent="stretch">
      ...
      <Grid row reverseDirection gap="40px" justifyContent="flex-end">
        <Grid column>
          <Input
            register={register('typeOfProposal')}
            variant={InputVariants.contained}
            label="מכירה/השכרה"
          />
        </Grid>
      ...
      <Grid row reverseDirection>
        <Grid column gap="58px">
          <WithExtraInfo extraInfo="סוגי קבצים מורשים: jpg, jpeg, png, Max. file size: 6 MB">
